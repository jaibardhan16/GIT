...
import com.spring.poc.token.AuthTokenInfo;
import com.spring.poc.token.User;

public class RestClient {
	private static Logger LOGGER = Logger.getLogger(RestClient.class);

	public static final String REST_SERVICE_URI = "http://localhost:8080/SpringBoot";

	public static final String AUTH_SERVER_URI = "http://localhost:8080/SpringBoot/oauth/token";

	public static final String QPM_PASSWORD_GRANT = "?grant_type=password&username=jay&password=password";
	...
	private static void listAllUsers(AuthTokenInfo tokenInfo) {
		...
		if (usersMap != null) {
			for (LinkedHashMap<String, Object> map : usersMap) {
				LOGGER.debug("User : id=" + map.get("id") + ", Name=" + map.get("name") + ", Age=" + map.get("age")
	...
	private static void createUser(AuthTokenInfo tokenInfo) {
		...
		LOGGER.debug("Location : " + uri.toASCIIString());
	}
